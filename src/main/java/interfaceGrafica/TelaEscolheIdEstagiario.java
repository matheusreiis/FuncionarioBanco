...
public class TelaEscolheIdEstagiario extends JPanel {

	private static final long serialVersionUID = 1L;
	TelaLobbyJFrame lobby = new TelaLobbyJFrame();

	public TelaEscolheIdEstagiario() throws Exception {
		setLayout(null);
		
		JLabel tituloEstagiario = new JLabel("SISTEMA ESTAGIARIO");
		tituloEstagiario.setForeground(SystemColor.text);
		tituloEstagiario.setHorizontalAlignment(SwingConstants.CENTER);
		tituloEstagiario.setFont(new Font("Calibri", Font.BOLD, 30));
		tituloEstagiario.setBounds(64, 13, 304, 89);
		add(tituloEstagiario);
