...
public class TelaEscolheIdGerente extends JPanel {
	
	private static final long serialVersionUID = 1L;
	TelaLobbyJFrame lobby = new TelaLobbyJFrame();

	public TelaEscolheIdGerente() throws Exception {
		setLayout(null);
		
		JLabel tituloGerente = new JLabel("SISTEMA GERENTE");
		tituloGerente.setForeground(SystemColor.text);
		tituloGerente.setHorizontalAlignment(SwingConstants.CENTER);
		tituloGerente.setFont(new Font("Calibri", Font.BOLD, 30));
		tituloGerente.setBounds(64, 13, 304, 89);
		add(tituloGerente);
